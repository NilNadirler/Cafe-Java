...
public class ProductServiceImpl implements ProductService {
        ...
        try {
         if(jwtFilter.isAdmin()){
             ...
             if(!optional.isEmpty()){
                 ...
                 return CafeUtils.getResponseEntity("Product Id is not exist", HttpStatus.BAD_REQUEST);
             }
         ...
         }else return CafeUtils.getResponseEntity(CafeConstants.UNAUTHORIZED_ACCESS,HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<String> deleteProduct(Integer id) {
        try {
            ...
            } else CafeUtils.getResponseEntity(CafeConstants.UNAUTHORIZED_ACCESS,HttpStatus.UNAUTHORIZED);
